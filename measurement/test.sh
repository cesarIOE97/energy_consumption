...
#program_path="your_program.py"  # Replace with the path to your Python program
...
# Monitor memory usage until the Python program ends
...
while kill -0 $pid 2>/dev/null; do
    ...
    echo $confirm_version,$2,$new_row >> $output_fileTop
    sleep 1
done
